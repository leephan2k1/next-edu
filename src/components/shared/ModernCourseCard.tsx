...
function ModernCourseCard() {
  ...
  return (
    <Link href={`/${PATHS.COURSE}/courseId`} className="full-size">
      <div className="aspect-h-6 aspect-w-5 relative mt-16 rounded-2xl bg-white shadow-xl dark:bg-dark-background">
        ...
        >
          ...
          <h2 className="mb-2 text-lg line-clamp-1 md:my-2">
            ...
            alias nihil nulla nostrum hic ipsa laborum corporis consectetur
            facere repudiandae ratione debitis enim porro tempore, quasi cum
            nemo suscipit exercitationem.
          </h2>
